...
[NULS-API offline operation tool download address] (http://nuls-usa-west.oss-us-west-1.aliyuncs.com/beta3/nuls-sdk-provider-offline.tar.gz)
...
## Interface List
### 0.1 Get information about this chain
#### Cmd: /api/info
_**Detailed description: Get information about this chain**_
#### HttpMethod: GET
...
_**Detailed description: Import account according to the keystore file path**_
#### HttpMethod: POST
...
_**Detailed description: Import account based on keystore string**_
#### HttpMethod: POST
...
_**Detailed description: Account backup, export AccountKeyStore file to the specified directory**_
#### HttpMethod: POST
...
_**Detailed description: Verify that the address format is correct**_
#### HttpMethod: POST
...
_**Detailed description: Calculate the commission fee for offline multi-sign account transfer transactions**_
#### HttpMethod: POST
...
_**Detailed description: Get information about the specified function of the published contract**_
#### HttpMethod: POST
...
_**Detailed description: Get a list of parameter types for the specified function of the published contract**_
#### HttpMethod: POST
...
_**Detailed description: Offline assembly - release contract transaction**_
#### HttpMethod: POST
...
_**Detailed description: Offline assembly - Calling contract transactions**_
#### HttpMethod: POST
...
_**Detailed description: Offline assembly - delete contract transaction**_
#### HttpMethod: POST
...
_**Detailed description: Offline assembly - contract token transfer transaction**_
#### HttpMethod: POST
...
_**Detailed description: Offline assembly - contract transaction from account address to contract address (main chain asset)**_
#### HttpMethod: POST
...
_**Detailed description: The input data of the interface is the output data of the trusted consensus transaction, and the nonce value can be empty**_
#### HttpMethod: POST
